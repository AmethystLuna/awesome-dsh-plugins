...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-20 12:37（UTC+8）。
...
| 14 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 427 | Codex-style @file mentions for DeepSeek Harness: search… |
