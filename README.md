...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-21 22:16（UTC+8）。
...
| 12 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 612 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
...
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 368 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
