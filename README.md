...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-19 07:47（UTC+8）。
...
| 13 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 411 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
