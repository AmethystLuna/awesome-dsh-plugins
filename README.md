...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-20 08:37（UTC+8）。
...
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2334 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 ｜ Open si… |
...
| 11 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 611 | AgentTeams plugin for DeepSeek Harness |
| 12 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 511 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 13 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 505 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
