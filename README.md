...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-21 00:10（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66984 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2448 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 ｜ Open si… |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 895 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 18 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 264 | GenUI for DeepSeek Harness: interactive UI components r… |
