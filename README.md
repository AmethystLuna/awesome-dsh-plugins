...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-18 12:36（UTC+8）。
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 665 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
