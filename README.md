...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-19 13:51（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66819 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4674 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
...
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2014 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 11 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 578 | AgentTeams plugin for DeepSeek Harness |
...
| 20 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 226 | GenUI for DeepSeek Harness: interactive UI components r… |
