...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-17 03:46（UTC+8）。
...
| 3 | [modlens](https://github.com/liustack/modlens) | 2355 | The first vision plugin for DeepSeek Harness, and the v… |
