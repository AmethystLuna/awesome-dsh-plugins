...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 20:33（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67161 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5523 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
...
| 10 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 795 | AgentTeams plugin for DeepSeek Harness |
...
| 19 | [whale-girl](https://github.com/vlln/whale-girl) | 263 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
