...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 20:57（UTC+8）。
...
| 10 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 796 | AgentTeams plugin for DeepSeek Harness |
