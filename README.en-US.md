...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-21 22:35（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67076 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5367 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3500 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2559 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 ｜ Open si… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2252 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 10 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 749 | AgentTeams plugin for DeepSeek Harness |
...
| 12 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 613 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 527 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
