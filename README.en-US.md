...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-21 04:51（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67006 | Compress tool outputs, logs, files, and RAG chunks befo… |
